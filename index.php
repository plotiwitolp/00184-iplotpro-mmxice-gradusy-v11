                ...
                <div class="hero__slider_sl swiper-slide">
                    <div class="hero__slider-inner">
                        <div class="hero__slider_sl_img">
                            <picture>
                                <source srcset="" type="image/webp">
                                <img src="<?php echo get_template_directory_uri() ?>/img/uslugi2/05_11zon.webp" alt="hero3">
                            </picture>
                        </div>
                        <div class="hero__slider_sl_content">
                            <!-- <div class="container"> -->
        ...
        <div class="container">
            <div class="services-team__in">
                <div class="services-team__head">
                    <h2 class="services-team__head_title section__title dark line-before">Специалисты</h2>
